...
export default function AppsGrid({
  ...
  return (
    <div className="w-full flex flex-col gap-2.5">
      ...
      {/* Touch-Friendly Scrollable Channels Workspace Container (Sized to match dashboard remote height) */}
      <div className="touch-scroll-panel max-h-[480px] lg:max-h-[510px] xl:max-h-[540px] space-y-3 pr-2 pb-2 overflow-y-auto">
